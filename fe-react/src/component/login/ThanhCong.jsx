...
function ThanhCong() {
  ...
  const { id } = useParams();
  async function handleGuiLaiMa() {
    const data = await useLoginStore.actions.guiLaiMa(id);
    openNotification(
      "success",
      "Hệ thống",
        ...
        <div className="login-option">
          <div className="login-option-site">
            <div className="login-option-header">
              ...
              <label htmlFor="">
                Quý khách không nhận email đăng ký?{" "}
                <span
                  onClick={handleGuiLaiMa}
                  style={{
                    color: "blue",
                    cursor: "pointer",
                  }}
