...
export const useGHN = {
    actions: {
        ...
        async layHuyen(payload) {
            return await ghn.post(`shiip/public-api/master-data/district?province_id=${payload}`)
        },
        async layXa(payload) {
            return await ghn.post(`shiip/public-api/master-data/ward?district_id=${payload}`)
        },
